...
namespace ConsoleApp5
{
    public class FileMonInterface: MarshalByRefObject
    {
        ...
        public void Info(String msg) {
            Console.WriteLine("The info is " + msg);
        }

        public void printPtr(String msg, IntPtr intPtr) {
            //Console.WriteLine(msg + " " + Convert.ToString(intPtr, 16));
        }
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            try
            {
                ...
                string injectionLibrary = Path.Combine(Path.GetDirectoryName(System.Reflection.Assembly.GetExecutingAssembly().Location), "ConsoleApp1.dll");
